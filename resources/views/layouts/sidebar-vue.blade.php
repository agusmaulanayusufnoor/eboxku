  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link" style="text-decoration: none;">
      <img src="{{ asset('assets/dist/img/logo-bprku.jpeg') }}" alt="BPRKU Logo" class="brand-image img-circle elevation-4" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview"
         role="menu" data-accordion="true">
            ...
            <li class="nav-item">
                ...
                <i class="nav-icon fas fa-user fa-beat green"></i>
                <p>
                    User
            ...
            @if ((auth()->user()->level_id==1) or auth()->user()->level_id==8)
            {{-- menu pelayanan --}}
